...
import com.antsstyle.artretweeter.gui.tweetpanels.UltimatePanel;
...
public class GUI extends javax.swing.JFrame {
    ...
    public static void preInitialisation() {
        ...
        ALL_CONTAINERS.add(PRIMARY_PANEL);
    ...
    public static UltimatePanel getPrimaryPanel() {
    ...
    private static final UltimatePanel PRIMARY_PANEL = new UltimatePanel();
