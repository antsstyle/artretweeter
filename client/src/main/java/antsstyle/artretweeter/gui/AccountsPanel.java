...
import static antsstyle.artretweeter.twitter.RESTAPI.CURRENTLY_PROCESSING;
...
public class AccountsPanel extends javax.swing.JPanel {
    ...
    private void addAccount() {
        ...
        ArrayList<Object> results = SwingTools.askForUserInput("Enter PIN",
        ...
        if (!authResult.getArtRetweeterStatusCode().equals(OperationResult.QUERY_OK)) {
            String errorMsg = "Select a collection to add this tweet to first.";
            JOptionPane.showMessageDialog(GUI.getInstance(), errorMsg, "Error", JOptionPane.ERROR_MESSAGE);
            LOGGER.error(msg);
            return;
        }
    ...
    private void removeAccount() {
        ...
        int accountNameColumnIndex = accountsTable.getColumnModel().getColumnIndex("Account Name");
        String screenName = (String) accountsTable.getModel().getValueAt(modelRow, accountNameColumnIndex);
        DBResponse deleteResp = CoreDB.deleteFromTable(DBTable.ACCOUNTS,
                new String[]{"screen_name"},
                new Object[]{screenName});
        if (!deleteResp.wasSuccessful()) {
            LOGGER.error("Account wasn't removed!");
        }
    }
