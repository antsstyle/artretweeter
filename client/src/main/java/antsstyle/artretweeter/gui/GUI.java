...
public class GUI extends javax.swing.JFrame {
    ...
    public static TweetsPanel getTweetsPanel() {
        return TWEETS_PANEL;
    }

    private static final AccountsPanel ACCOUNTS_PANEL = new AccountsPanel();
    private static final TweetsPanel TWEETS_PANEL = new TweetsPanel();
    ...
    private static final antsstyle.artretweeter.gui.PrimaryDisplayPanel PRIMARY_DISPLAY_PANEL = new antsstyle.artretweeter.gui.PrimaryDisplayPanel();
