...
class Statuses {
    ...
    public static function retrieveTweetMetrics($userAuth) {
        ...
        if (!$metricsInDB) {
            echo Core::encodeStatusInformation(StatusCodes::DATABASE_ERROR, "A server error was encountered attempting to retrieve tweet metrics.");
            exit;
        }
    ...
    public static function statusesShow($userAuth) {
