        ...
        <div class="main">
            ...
            <div class="center">
                <button class="settingsswitchbutton" type="button" 
                        onclick="window.location.href = '<?php echo Config::HOMEPAGE_URL . "artistsimplesettings"; ?>';">Simple Settings</button>
                <button class="settingsswitchbutton" type="button" disabled>Advanced Settings</button>
            </div>
            <form action="saveartistsettings" method="post">
                ...
                <div class="formsection" style="max-width:600px;">
                    ...
                    <div class="content" style="width:100%;">
                        ...
                        <label for="metricspercent"></label>
                        <input type="text" id="metricspercent" name="metricspercent"
                               onkeyup="checkValidRetweetPercent('metricspercent', 'metricspercenterrormsg')" value="20">
                        <label for="metricsmethod">Metrics method type:</label>
                        <select name="metricsmethod" id="metricsmethod">
                            <option selected value="adaptive">Adaptive</option>
                            <option value="mean_average">Mean Average</option>
                        </select>
                    </div>
                </div>
                    ...
                    <table>
                        ...
                        for ($i = 0; $i < 24; $i++) {
                            ...
                            $input = "<td><input type=\"checkbox\" id=\"" . $concatString . "\" name=\"" . $concatString
                                    ...
                                    . $concatString . "\"><label for=\"" . $concatString . "\" checked=\"checked\"> "
                                    . $iString . ":00 - " . $jString . ":00 </label>"
                                    . "&nbsp;&nbsp;</td>";
                            echo $input;
                        }
                        ?>
                ...
                <h4>Minute Interval Settings</h4>
                These correspond to times past the hour that ArtRetweeter will schedule retweets for.
                <br/>
                <div id="minuteintervalserrormsg" class="errormsg">
                    &nbsp;
                </div>
                <div class="formsection" style="max-width:600px;">
                    <table>
                        <tr>
                            <td>
                                <input type="checkbox" id="minute0" name="minute0" value="minute_0" checked="checked"
                                       class="minutecheckbox" onclick="checkValidMinutes()">
                                <label for="minute0"> 0 </label>
                            </td>
                            <td>
                                <input type="checkbox" id="minute15" name="minute15" value="minute_15" checked="checked"
                                       class="minutecheckbox" onclick="checkValidMinutes()">
                                <label for="minute15"> 15 </label>
                            </td>
                            <td>
                                <input type="checkbox" id="minute30" name="minute30" value="minute_30" checked="checked"
                                       class="minutecheckbox" onclick="checkValidMinutes()">
                                <label for="minute30"> 30 </label>
                            </td>
                            <td>
                                <input type="checkbox" id="minute45" name="minute45" value="minute_45" checked="checked"
                                       class="minutecheckbox" onclick="checkValidMinutes()">
