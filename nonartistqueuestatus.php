...
<html>
    ...
    <body onload="initialiseQueueStatus()">
        <div class="main">
            ...
            <h1>ArtRetweeter</h1>
            <h2>Non-Artist Retweet Queue</h2>
            <b>This page shows your queued retweets for other accounts. If you want to see your queued retweets for your own account, 
                go to the <a href=<?php echo Config::ARTISTQUEUESTATUS_URL ?>>Artists Queue Status</a> page.</b><br/><br/>
            <?php
            if ($userInfo === false) {
                ...
                foreach ($queuedRetweets as $queuedRetweet) {
                    ...
                    $tweetAuthor = "@" . $queuedRetweet['screenname'];
                    ...
                    $echoStr = "<div class=\"queuedtweet\" id=\"$scheduledID\">Tweet ID: <a href=\"$tweetURL\" target=\"_blank\">$tweetID</a>"
                            . "<br/>Tweet author: $tweetAuthor<br/>"
